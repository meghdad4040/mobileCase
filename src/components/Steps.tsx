            ...
            <div>
              ...
              >
                ...
                <span className="ml-4 h-full mt-0.5 flex min-w-0 flex-col justify-center">
                  <span
                    className={cn(
                      "text-sm font-semibold text-gray-700 dark:text-gray-300  cursor-context-menu",
                      {
                        "text-primary dark:text-primary": isCompleted,
                  ...
                  <span className="text-sm text-gray-500 dark:text-gray-400 cursor-context-menu">
                    {step.description}
                  </span>
                </span>
              </span>
